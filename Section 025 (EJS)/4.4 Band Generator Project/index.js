...
app.post("/submit", (req, res) => {
  ...
  let wordAdj = adj[Math.floor((Math.random() * adj.length) - 1)];
  let wordNoun = noun[Math.floor((Math.random() * adj.length) - 1)];

  let bandName = `${wordAdj} ${wordNoun}`;
  ...
  //3. Test to   element in index.ejs
});
